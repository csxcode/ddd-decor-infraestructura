...
<div class="modal fade" id="{{$prefix}}">    
    <form id="{{$prefix}}_form" action="{{route('checklist_structure.type.save', ':PARAM_ID', false)}}" class="form-horizontal" data-toggle="validator" role="form">   
        {{ csrf_field() }}
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    @if($action != App\Enums\ActionEnum::VIEW)
                        <button type="button" class="btn btn-success" onclick="SaveTypeModal({{$data->id}})"><i class="fa fa-save" aria-hidden="true"></i>&nbsp;Guardar</button>
                    @endif
