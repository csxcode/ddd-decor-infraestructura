...
<p>Su cotización fue aprobada y usted ha sido asignado para ejecutar la siguiente OT (orden de trabajo)</p>
...
<div>
    <table cellpadding="10" cellspacing="0" border="1" style="table-layout: fixed;margin-top: 20px;margin-bottom: 20px; border: 1px solid #171c21">
        ...
        <tr>
            <td style="vertical-align: top;background-color: #242A30;width: 140px;font-weight: bold;color:#fff">Monto Aprobado:</td>
            <td>{{ $quote->amount . ' ' . \FunctionHelper::getCurrencyName($quote->currency) }} </td>
        </tr>
        <tr>
            <td style="vertical-align: top;background-color: #242A30;width: 140px;font-weight: bold;color:#fff">Tiempo Aprobado:</td>
