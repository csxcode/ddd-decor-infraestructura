...
use App\UseCases\WorkOrder\Create;
...
class WorkOrderController extends Controller
{
    ...
    public function __construct(
        ...
        WorkOrderSearchViewService $workOrderSearchViewService,
    ...
    public function store(Create $createAction)
    {
        try {
            // --------------------------------------------
            // Validations
            ...
            $data = $createAction->execute($params, $this->workOrderValidation->user);
    ...
    public function update($id)
    {
        try {
            ...
            if ($changes) {
                ...
                return ErrorHelper::sendResponseNoChanges($this->resource, $workOrder->id, $extraData);
            }
